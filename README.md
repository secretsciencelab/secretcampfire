...
## `Easy peasy lemon squeezy` instructions  (time needed: 0 minutes)

If you're not the DIY type and prefer to have all this done for you, email [getscampy@secretcampfire.com](mailto:getscampy@secretcampfire.com) and we'll take care of you. We'll set up 5 blogs for you for a one-time fee of $5. After they're set up, your blogs still belong 100% to you and run free forever.*
