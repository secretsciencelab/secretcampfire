...
In contrast, `secret campfire` will show you exactly how to run your own server so you can finally be independent and free. But of course, our goal is to make it as simple as possible so it's only as hard as it needs to be but no harder.

--- 

## I have a suggestion / I found a problem / I want to help / I want to thank you from the bottom of my heart / I am a big fan
